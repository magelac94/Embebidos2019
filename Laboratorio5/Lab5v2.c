...
main(){
	...
	Error = OSTaskCreate(GPS_init, NULL, 256, 9);  // Inicializa Hardware GPS - Ejecuta 1 vez
	Error = OSTaskCreate(GPS_gets, p_str, 256, 10); // Se obtiene datos gps
	Error = OSTaskCreate(GPS_configRTC, NULL, 256, 11); // Configura el Reloj Periodicamente
